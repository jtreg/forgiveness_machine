...
public class processingReceiveTestb extends PApplet {
...
class Circle {
  ...
  public void settings() {  size(1000, 820); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "processingReceiveTestb" };
    if (passedArgs != null) {
